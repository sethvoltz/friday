...
const SYSTEM_PROMPT = [
  ...
  "",
  "Worked example — quoting the user mid-sentence:",
  '  Correct:   "User said: \\"Nah just go,\\" overriding plan mode."',
  '  Incorrect: "User said: "Nah just go," overriding plan mode."',
  "",
  "The incorrect form was the FRI-64 day-23 enrich failure: a mid-sentence",
  "quote closed the outer JSON string and the parser rejected the rest.",
  "When in doubt, prefer prose phrasing over inline quoting (`The user told",
  "the agent to skip planning.` reads as well as the quoted version and has",
  "zero escape risk).",
  "",
