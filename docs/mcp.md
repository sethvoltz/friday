...
| `friday-reminder`     | `reminder_create`, `reminder_list`, `reminder_cancel` (user-facing chat nudges that fire without waking any agent; reachable by every agent type, incl. app sub-agents)                                            |      ✓       |    ✓    |   ✓    |     ✓     |   ✓   |
