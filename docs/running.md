...
| `compaction.sweepThresholdTokens`                 | `60000`              | The sweep only `/compact`s a live, idle orchestrator, helper, or bare agent whose estimated live context exceeds this.                                                |
